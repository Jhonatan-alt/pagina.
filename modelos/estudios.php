            ...
            <div class="modal-body">
              <form method="POST" id="usuario_form">
                ...
                <div class="row mb-3 mx-2 my-1">
                    <label for="nombre" class="col-form-label">Institucion:</label>  
                    <div class="col">                                
                        <input class="form-control" type="text" name="nombre" id="nombre" placeholder="Ingrese el nombre de la institucion del usuario">
                    </div>
                </div>
                <div class="row mb-3 mx-2 my-1">
                    <label for="ape_paterno" class="col-form-label">titulo:</label>
                    <div class="col">                                
                        <input class="form-control" type="text" name="ape_paterno" id="ape_paterno" placeholder="Ingrese el titulo del usuario">
                    </div>       
                </div>
                <div class="row mb-3 mx-2 my-1">
