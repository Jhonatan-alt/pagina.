...
(1, 1, 771498, '2023-06-01 18:25:17', 1);
...
(771498, 'Jose David', 'Verastegui', 'Arcos', 'jose.verastegui@uniminuto.edu.co', 'Jos2022*', 'M', '3178513582', '2023-08-22 18:25:17', 1);
...
--
ALTER TABLE `curso_usuario`
  MODIFY `curusu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `usuarios`
  MODIFY `usu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=771499;
